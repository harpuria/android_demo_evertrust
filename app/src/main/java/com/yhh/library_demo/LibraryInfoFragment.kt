...
class LibraryInfoFragment : Fragment(), TextWatcher {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_library_info, container, false)
    ...
    fun initView(view: View){
        recyclerView = view.findViewById(R.id.libInfoRecyclerView)
        searchEditText = view.findViewById(R.id.searchEditText)
    }
}

// 리사이클러 어댑터 정의
class LibraryRecyclerViewAdapter(): RecyclerView.Adapter<LibraryRecyclerViewAdapter.ViewHolder>(),
    Filterable {
    var dataList = mutableListOf<Map<String, String>>()
